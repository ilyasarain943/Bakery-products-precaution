# -*- coding: utf-8 -*-
"""Red_Velvet Cake.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1zNX7JZw1TjYJXv0OCaH21zKU0NYpgwJH
"""
...
p1_data=pd.read_csv("Red_Velvet_Metrics_Clean.csv")
...
'''p1 = pd.get_dummies(p1_data, columns=['Day_of_the_Week'], prefix='Day')
p1.head()'''
...
x = p1_data.drop(columns=['Red Velvet Cake Units Sold'])
y = p1_data['Red Velvet Cake Units Sold']
x.head()
